...
const PBIZCatalog = (() => {
  ...
  const SAMPLE_PRODUCTS = [
    {
      id: 1,
      title: 'Reversible Floral Jacket',
      category: 'jackets',
      ...
      icon: 'fa-vest',
      description: 'A must-have reversible jacket with romantic floral print. Two looks in one — designed in LA.',
      features: ['Reversible Design', 'Machine Washable', 'S–XL'],
    },
    {
      id: 2,
      title: 'Embroidered Ivory Blouse',
      category: 'tops',
      ...
      icon: 'fa-shirt',
      description: 'Delicate floral embroidery on a soft ivory blouse. Perfect for layering or wearing solo.',
      features: ['Embroidered Detail', 'Breathable Fabric', 'S–XL'],
    },
    {
      id: 3,
      title: 'Sleeveless Embroidered Midi',
      category: 'dresses',
      collection: 'trending',
      price: 0,
      priceLabel: '',
      ...
      description: 'A romantic sleeveless midi dress with intricate embroidery detail. Effortless elegance.',
      features: ['Embroidered Bodice', 'Midi Length', 'S–XL'],
    },
    {
      id: 4,
      title: 'Floral Print Matching Set',
      ...
      icon: 'fa-shirt',
      description: 'A coordinated top and skirt set in a vibrant floral print. The matching moment your customers want.',
      features: ['2-Piece Set', 'Mix & Match', 'S–XL'],
    },
    {
      id: 5,
      title: 'Embroidered Kimono Wrap',
      ...
      icon: 'fa-vest',
      description: 'Flowing kimono wrap with hand-inspired embroidery. Resort-ready and utterly romantic.',
      features: ['Open Front', 'Embroidered Trim', 'One Size'],
    },
    {
      id: 6,
      title: 'Romantic Rose Maxi Dress',
      category: 'dresses',
      collection: 'trending',
      price: 0,
      priceLabel: '',
      ...
      reviewCount: 64,
      badge: 'trending',
      gradient: 'linear-gradient(135deg, #f5c6d0, #c8658e)',
      icon: 'fa-vest-patches',
      description: 'A floor-length maxi dress with a romantic rose print. Designed in Los Angeles.',
      features: ['Maxi Length', 'Soft Poly-Blend', 'S–XL'],
    },
    {
      id: 7,
      ...
      icon: 'fa-shirt',
      description: 'A relaxed-fit tee with delicate floral embroidery at the neckline. Effortless everyday style.',
      features: ['Relaxed Fit', 'Embroidered Neckline', 'S–XL'],
    },
    {
      id: 8,
      title: 'Embroidered Wide-Leg Pants',
      ...
      icon: 'fa-vest',
      description: 'Comfortable wide-leg pants with embroidered hem detail. Pairs beautifully with our tops.',
      features: ['Wide Leg', 'Elastic Waist', 'S–XL'],
    },
    {
      id: 9,
      title: 'Lace-Trim Cardigan',
      category: 'jackets',
      collection: 'trending',
      price: 0,
      priceLabel: '',
      ...
      icon: 'fa-vest',
      description: 'An open-front cardigan with delicate lace trim. The perfect lightweight layering piece.',
      features: ['Lace Trim', 'Open Front', 'S–XL'],
    },
    {
      id: 10,
      title: 'Tropical Print Resort Dress',
      category: 'resort-wear',
      collection: 'new-arrivals',
      price: 0,
      priceLabel: '',
      ...
      icon: 'fa-vest-patches',
      description: 'A breezy resort dress in vibrant tropical print. Vacation-ready and boutique-approved.',
      features: ['V-Neckline', 'Tropical Print', 'S–XL'],
    },
    {
      id: 11,
      title: 'Boho Embroidered Skirt',
      category: 'pants-skirts',
      collection: 'trending',
      price: 0,
      priceLabel: '',
      ...
      icon: 'fa-vest',
      description: 'A flowing boho-inspired skirt with embroidered waistband detail. Pairs with any top.',
      features: ['Midi Length', 'Embroidered Waist', 'S–XL'],
    },
    {
      id: 12,
      title: 'Ruffle Sleeve Coordinates Set',
      category: 'coordinates',
      collection: 'best-sellers',
      price: 0,
      priceLabel: '',
      ...
      icon: 'fa-shirt',
      description: 'A chic ruffle-sleeve top paired with matching wide-leg pants. Effortless head-to-toe style.',
      features: ['2-Piece Set', 'Ruffle Sleeves', 'S–XL'],
    },
  ];
      ...
      <div class="product-card" data-category="${product.collection}" data-id="${product.id}">
        ...
        <div class="product-card__info">
          ...
          <div class="product-card__price">
            <span class="product-card__price-current">${product.priceLabel || '$' + product.price.toFixed(2)}</span>
          </div>
        </div>
      </div>
    `;
    ...
    body.innerHTML = `
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; align-items: start;">
        ...
        <div>
          ...
          <p style="font-size: 1.75rem; font-weight: 700; color: #c8658e; margin-bottom: 1rem;">${product.priceLabel || '$' + product.price.toFixed(2)}</p>
